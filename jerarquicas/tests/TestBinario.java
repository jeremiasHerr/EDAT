...
public class TestBinario {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("Inserto hijo D a raiz en pos llena. Tiene que dar: " + sErr + " --> " + ((a.insertar(5, 10, false)) ? sOk : sErr));
        System.out.println("Inserto elemento duplicado en pos valida 10 como hijo I de 3. Tiene que dar " + sOk + " --> " + ((a.insertar(10, 3, true)) ? sOk : sErr));
        ...
        System.out.println("\n");
        System.out.println("Inserto el 25 como hijo D de 20 en CLON" + ((b.insertar(25, 20, false)) ? sOk : sErr));
        System.out.println("Inserto el 35 como hijo I de 20 en CLON" + ((b.insertar(35, 20, true)) ? sOk : sErr));
        System.out.println("\n" + AZUL + "CLON toString() \t\t\t");
        System.out.println("\n clon toString()  deberia dar: \n"
                + "            10 \n"
                + "        /       \\    \n"
